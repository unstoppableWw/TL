    ...
    <div class="content">
      <div class="content1">
        ...
        <div class="announcement">
          ...
          <div class="title">
            <ul>
              <li v-for="(inform, index) in tabs" :key="index" @mouseover="onTabMouseOver(index)"
                :class="{ 'active-tabs': activeTab === index }">
                {{ inform }}
                <div v-if="activeTab == index"
                  style="width: 15px;height: 3px; background-color: #4095E5;border-radius: 10px; margin-top: 5px;"></div>
              </li>
      ...
      <div
        style="width: 100%;height: 50px;margin-top: 120px;color:#676767; display: flex;justify-content: center;align-items: center;font-size: 30px;">
        产品介绍</div>
      <div style="width: 100%;border: #efefef solid 1px;"></div>
